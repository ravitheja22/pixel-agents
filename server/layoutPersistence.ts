...
/**
 * Load layout from file, or write defaultLayout to file and return it.
 * No workspace state migration needed in standalone server.
 */
...
/**
 * Watch ~/.pixel-agents/layout.json for external changes (other VS Code windows, other server instances).
